...
class Message(Model):
    ...
    def id_message(self) -> int:
        """Gets the id_message of this Message.

        Message ID  # noqa: E501

        :return: The id_message of this Message.
        :rtype: int
        """
    ...
    def id_message(self, id_message: int):
        """Sets the id_message of this Message.

        Message ID  # noqa: E501

        :param id_message: The id_message of this Message.
        :type id_message: int
        """
    ...
    def id_sender(self) -> int:
        """Gets the id_sender of this Message.

        Sender ID  # noqa: E501

        :return: The id_sender of this Message.
        :rtype: int
        """
    ...
    def id_sender(self, id_sender: int):
        """Sets the id_sender of this Message.

        Sender ID  # noqa: E501

        :param id_sender: The id_sender of this Message.
        :type id_sender: int
        """
    ...
    def message_delivered(self) -> bool:
        """Gets the message_delivered of this Message.

        flag for message delivery  # noqa: E501

        :return: The message_delivered of this Message.
        :rtype: bool
        """
    ...
    def message_delivered(self, message_delivered: bool):
        """Sets the message_delivered of this Message.

        flag for message delivery  # noqa: E501

        :param message_delivered: The message_delivered of this Message.
        :type message_delivered: bool
        """
    ...
    def message_read(self) -> bool:
        """Gets the message_read of this Message.

        flag for message read  # noqa: E501

        :return: The message_read of this Message.
        :rtype: bool
        """
    ...
    def message_read(self, message_read: bool):
        """Sets the message_read of this Message.

        flag for message read  # noqa: E501

        :param message_read: The message_read of this Message.
        :type message_read: bool
        """
